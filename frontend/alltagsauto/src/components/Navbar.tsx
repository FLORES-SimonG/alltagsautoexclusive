...
export default function Navbar() {
  return (
    <nav className="bg-gray-800 px-8 py-3 flex flex-row justify-between items-center">
      ...
      <button className="text-white flex py-3 px-10 justify-center items-center gap-8 border-white border-2 rounded-lg hover:border-tertiary transition-colors">
        Anmelden
      </button>
    </nav>
  );
