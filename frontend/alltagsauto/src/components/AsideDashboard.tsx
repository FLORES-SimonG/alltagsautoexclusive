...
export default function AsideDashboard(){
          ...
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            ...
            <ul className="mt-2 space-y-1 px-4">
              ...
              <li>
                <a
                  href="#"
                  className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-red-700"
                >
                  Delete Account
                </a>
              </li>
    ...
    <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
      ...
      >
        ...
        <div>
          <p className="text-xs">
            <strong className="block font-medium">Simón G. Flores</strong>

            <span> simon@gflores.com </span>
          </p>
        </div>
      </a>
    </div>
